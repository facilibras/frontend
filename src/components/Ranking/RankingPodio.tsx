...
export const RankingPodio = ({ users }: RankingPodioProps) => {
    ...
    const [podioImages, setPodioImages] = useState<(string | null)[]>([null, null, null]);

    useEffect(() => {

        for (let i = 0; i < 3; i++) {
            const imagemData = users[i].imagemPerfil;

            if (imagemData && imagemData instanceof Blob) {

                const url = URL.createObjectURL(imagemData);
                setPodioImages(prevImages => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center relative scale-[1.05] z-[5]">
                ...
                <div className="mt-8">
                    <img src={podioImages[0] ?? NoUser} alt="Foto de perfil"
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center relative scale-[1.1] z-10">
                ...
                <div className="mt-10">
                    <img src={podioImages[1] ?? NoUser} alt="Foto de perfil"
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center relative scale-[1.02] z-[3]">
                ...
                <div className="mt-8">
                    <img src={podioImages[2] ?? NoUser} alt="Foto de perfil" className="w-20 h-20 rounded-full mx-auto mb-4 border-4 border-amber-700" />
